...
"""
VAE components, copied from
https://github.com/PyTorchLightning/pytorch-lightning-bolts/blob/9503df5c132541ded58da1f477062e313b711d56/pl_bolts/models/autoencoders/components.py
"""
...
class ResNetDecoder(nn.Module):
    ...
    def __init__(self, block, layers, latent_dim, input_height, learn_variance=False, first_conv=False, maxpool1=False):
        super().__init__()
        ...
        self.conv2 = nn.Conv2d(
            64 * block.expansion, 16, kernel_size=3, stride=1, padding=1, bias=False
        )
...
def resnet18_decoder(latent_dim, input_height, first_conv, maxpool1, learn_variance=False):
    return ResNetDecoder(DecoderBlock, [2, 2, 2, 2], latent_dim, input_height, learn_variance, first_conv, maxpool1)
...
def resnet50_decoder(latent_dim, input_height, first_conv, maxpool1, learn_variance=False):
    return ResNetDecoder(DecoderBottleneck, [3, 4, 6, 3], latent_dim, input_height, learn_variance, first_conv, maxpool1)