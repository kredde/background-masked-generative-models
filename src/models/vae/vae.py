...
"""
Standard VAE implementation, copied from
https://github.com/PyTorchLightning/pytorch-lightning-bolts/blob/9503df5c132541ded58da1f477062e313b711d56/pl_bolts/models/autoencoders/basic_vae/basic_vae_module.py
"""
...
class VAE(LightningModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Args:
            input_dim: dimension of the images
            ...
            dec_out_dim: 3072 ====> 3 x 32 x 32
            kl_coeff: coefficient for kl term of the loss
            latent_dim: dim of latent space
            output_dim: dim of output space
        ...
        if enc_type not in valid_encoders:
            ...
            self.decoder = resnet18_decoder(self.latent_dim, self.input_dim[0], first_conv, maxpool1)
        else:
            self.encoder = valid_encoders[enc_type]['enc'](first_conv, maxpool1)
            self.decoder = valid_encoders[enc_type]['dec'](self.latent_dim, self.input_dim[0], first_conv, maxpool1)
